    ...
    (function(module2, exports2) {
      ...
      BN2.prototype.iuor = function iuor(num2) {
        ...
        for (var i2 = 0; i2 < num2.length; i2++) {
          this.words[i2] = this.words[i2] | num2.words[i2];
        }
        return this._strip();
      };
      ...
      BN2.prototype.modrn = function modrn(num2) {
        ...
        for (var i2 = this.length - 1; i2 >= 0; i2--) {
          acc = (p * acc + (this.words[i2] | 0)) % num2;
        }
      ...
      K256.prototype.imulK = function imulK(num2) {
        ...
        var lo = 0;
        for (var i2 = 0; i2 < num2.length; i2++) {
          var w = num2.words[i2] | 0;
          lo += w * 977;
          num2.words[i2] = lo & 67108863;
      ...
      P25519.prototype.imulK = function imulK(num2) {
        var carry = 0;
        for (var i2 = 0; i2 < num2.length; i2++) {
          var hi = (num2.words[i2] | 0) * 19 + carry;
          var lo = hi & 67108863;
          hi >>>= 26;
          num2.words[i2] = lo;
          carry = hi;
      ...
      Red.prototype.pow = function pow(a, num2) {
        ...
        for (i2 = num2.length - 1; i2 >= 0; i2--) {
          var word = num2.words[i2];
...
//# sourceMappingURL=chunk-YCAZ4CK7.js.map
