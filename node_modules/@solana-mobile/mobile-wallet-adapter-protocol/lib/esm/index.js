...
function createNostrEvent(kind, content, tags, privateKey) {
	...
	return {
		...
		tags,
		content,
		sig: bytesToHex(schnorr.sign(hexToBytes(id), privateKey))
	};
}
...
//#endregion
export { NOSTR_EVENT_KIND_MWA, SolanaCloneAuthorization, SolanaMobileWalletAdapterError, SolanaMobileWalletAdapterErrorCode, SolanaMobileWalletAdapterProtocolError, SolanaMobileWalletAdapterProtocolErrorCode, SolanaSignInWithSolana, SolanaSignTransactions, createNostrEvent, deriveSessionIdentifier, generateNostrKeypair, startNostrScenario, startRemoteScenario, startScenario, transact, verifyNostrEvent };
