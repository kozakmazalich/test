...
import { BaseTransactionPlanResultContext, SingleTransactionPlanResult, type SuccessfulBaseTransactionPlanResultContext, type TransactionPlanResult, type TransactionPlanResultContext } from './transaction-plan-result';
/**
...
type SuccessfulTransactionPlanResultContext<TContext extends TransactionPlanResultContext> = SuccessfulBaseTransactionPlanResultContext & TContext;
type ExecuteTransactionMessage<TContext extends TransactionPlanResultContext, TReturn = Signature | SuccessfulTransactionPlanResultContext<TContext> | Transaction> = (context: BaseTransactionPlanResultContext & TContext, transactionMessage: TransactionMessage & TransactionMessageWithFeePayer, config?: {
    abortSignal?: AbortSignal;
}) => Promise<TReturn>;
/**
 ...
 */
export declare function createTransactionPlanExecutor<TContext extends TransactionPlanResultContext = TransactionPlanResultContext>(config: {
