    ...
    memoizedKeypaths = {
      ...
      getBlock: [
        ...rpcTransformers.tokenBalancesConfigs.flatMap((c) => [
          ["transactions", rpcTransformers.KEYPATH_WILDCARD, "meta", "preTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c],
          ["transactions", rpcTransformers.KEYPATH_WILDCARD, "meta", "postTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c]
        ]),
        ...
        ["transactions", rpcTransformers.KEYPATH_WILDCARD, "version"],
      ...
      getTransaction: [
        ...rpcTransformers.tokenBalancesConfigs.flatMap((c) => [
          ["meta", "preTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c],
          ["meta", "postTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c]
        ]),
      ...
      getTransactionsForAddress: [
        ["data", rpcTransformers.KEYPATH_WILDCARD, "transactionIndex"],
        ...rpcTransformers.tokenBalancesConfigs.flatMap((c) => [
          ["data", rpcTransformers.KEYPATH_WILDCARD, "meta", "preTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c],
          ["data", rpcTransformers.KEYPATH_WILDCARD, "meta", "postTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c]
        ]),
        ["data", rpcTransformers.KEYPATH_WILDCARD, "meta", "rewards", rpcTransformers.KEYPATH_WILDCARD, "commission"],
        ...rpcTransformers.innerInstructionsConfigs.map((c) => [
          "data",
          rpcTransformers.KEYPATH_WILDCARD,
          "meta",
        ...
        ...rpcTransformers.messageConfig.map((c) => ["data", rpcTransformers.KEYPATH_WILDCARD, "transaction", "message", ...c]),
        ["data", rpcTransformers.KEYPATH_WILDCARD, "version"]
      ],
      ...
      simulateTransaction: [
        ...
        ...rpcTransformers.tokenBalancesConfigs.flatMap((c) => [
          ["value", "preTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c],
          ["value", "postTokenBalances", rpcTransformers.KEYPATH_WILDCARD, ...c]
        ])
      ]
    };
  }
