...
import type { Base58EncodedDataResponse, Base64EncodedDataResponse, Commitment, Slot, TransactionError, UnixTimestamp } from '@solana/rpc-types';
import type { TransactionVersion } from '@solana/transaction-messages';
import type { TransactionAddressTableLookups, TransactionJson, TransactionJsonParsed, TransactionMetaBase, TransactionMetaInnerInstructionsNotParsed, TransactionMetaInnerInstructionsParsed, TransactionMetaLoadedAddresses } from './transaction-meta';
 ...
 */
type GetTransactionsForAddressFullMetaNotParsedLegacy = (TransactionMetaBase & TransactionMetaInnerInstructionsNotParsed) | null;
/**
 ...
 */
type GetTransactionsForAddressFullMetaNotParsedVersioned = (TransactionMetaBase & TransactionMetaInnerInstructionsNotParsed & TransactionMetaLoadedAddresses) | null;
/**
 * The transaction metadata returned for a legacy `'full'`, `jsonParsed`-encoded result. Legacy
 * results omit `loadedAddresses`.
 */
type GetTransactionsForAddressFullMetaParsedLegacy = (TransactionMetaBase & TransactionMetaInnerInstructionsParsed) | null;
/**
 * The transaction metadata returned for a versioned `'full'`, `jsonParsed`-encoded result.
 * Versioned results carry `loadedAddresses`.
 */
type GetTransactionsForAddressFullMetaParsedVersioned = (TransactionMetaBase & TransactionMetaInnerInstructionsParsed & TransactionMetaLoadedAddresses) | null;
/**
 ...
 */
type GetTransactionsForAddressFullJsonParsed<TMaxSupportedTransactionVersion extends TransactionVersion | void> = TMaxSupportedTransactionVersion extends void ? GetTransactionsForAddressFullBase & Readonly<{
    meta: GetTransactionsForAddressFullMetaParsedLegacy;
    transaction: TransactionJsonParsed;
}> : GetTransactionsForAddressFullBase & GetTransactionsForAddressVersion & Readonly<{
 ...
 * `meta` carries `loadedAddresses`, and the message carries `addressTableLookups`.
 */
type GetTransactionsForAddressFullJson<TMaxSupportedTransactionVersion extends TransactionVersion | void> = TMaxSupportedTransactionVersion extends void ? GetTransactionsForAddressFullBase & Readonly<{
 ...
 */
type GetTransactionsForAddressFullEncoded<TMaxSupportedTransactionVersion extends TransactionVersion | void, TTransaction> = TMaxSupportedTransactionVersion extends void ? GetTransactionsForAddressFullBase & Readonly<{
    meta: GetTransactionsForAddressFullMetaNotParsedLegacy;
...
export type GetTransactionsForAddressApi = {
     ...
     */
    getTransactionsForAddress(address: Address, config: GetTransactionsForAddressCommonConfig & GetTransactionsForAddressFullOnlyConfig & Readonly<{
        encoding: 'jsonParsed';
        maxSupportedTransactionVersion: GetTransactionsForAddressMaxSupportedTransactionVersion;
     ...
     */
    getTransactionsForAddress(address: Address, config: GetTransactionsForAddressCommonConfig & Omit<GetTransactionsForAddressFullOnlyConfig, 'maxSupportedTransactionVersion'> & Readonly<{
        encoding: 'jsonParsed';
        transactionDetails: 'full';
     ...
     * {@label signatures}
     */
    getTransactionsForAddress(address: Address, config?: GetTransactionsForAddressCommonConfig & Readonly<{
