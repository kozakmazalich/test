...
import type { Base58EncodedBytes, Base64EncodedDataResponse, Blockhash, Lamports, Reward, TokenBalance, TransactionError, TransactionStatus } from '@solana/rpc-types';
/**
 ...
 */
export type TransactionInstruction = InstructionWithData & Partial<InstructionWithStackHeight> & Readonly<{
    /**
 ...
 */
export type PartiallyDecodedTransactionInstruction = InstructionWithData & Partial<InstructionWithStackHeight> & Readonly<{
 ...
 */
export type ParsedTransactionInstruction = Partial<InstructionWithStackHeight> & Readonly<{
...
//# sourceMappingURL=transaction-meta.d.ts.map