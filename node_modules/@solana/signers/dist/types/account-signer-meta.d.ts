...
type AccountMetaWithoutSigner = Readonly<{
    signer?: never;
}> & (AccountLookupMeta | AccountMeta);
type UnionKeys<T> = T extends unknown ? keyof T : never;
type TransactionSignerMethodKeys = Exclude<UnionKeys<TransactionSigner>, keyof TransactionMessageWithFeePayer['feePayer']>;
type WithoutSignerMethods = Readonly<{
    [K in TransactionSignerMethodKeys]?: never;
}>;
 ...
 */
type AccountMetaWithSigner<TSigner extends TransactionSigner = TransactionSigner> = AccountMetaWithoutSigner | AccountSignerMeta<string, TSigner>;
/**
 ...
 * ```
 */
export type TransactionMessageWithSigners<TAddress extends string = string, TSigner extends TransactionSigner<TAddress> = TransactionSigner<TAddress>, TAccounts extends readonly AccountMetaWithSigner<TSigner>[] = readonly AccountMetaWithSigner<TSigner>[]> = Partial<Pick<TransactionMessageWithFeePayerSigner<TAddress, TSigner> | TransactionMessageWithNonSignerFeePayer<TAddress>, 'feePayer'>> & Readonly<{
