...
type SupportedTransactionMessage = Extract<TransactionMessage, {
    version: 0;
}>;
 ...
 * ```
 */
export declare function compressTransactionMessageUsingAddressLookupTables<TTransactionMessage extends SupportedTransactionMessage = SupportedTransactionMessage>(transactionMessage: TTransactionMessage, addressesByLookupTableAddress: AddressesByLookupTableAddress): TTransactionMessage | WidenTransactionMessageInstructions<TTransactionMessage>;
export {};
